<template>
  <div :ref="'container_receiving'+id" class="row items-start content-start" style="overflow-y:scroll;background-color:transparent;height:100%;width:50%;">
...
export default {
  ...
  methods: {
      ...
      var container = this.$refs["container_receiving"+this.id];
